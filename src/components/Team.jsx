...
const COACHES = [
  {
    ...
    achievements: `Мастер спорта международного класса
                    ...
                    Двукратный Победитель международных соревнований "Кубок Оямы" (Хабаровск, 2000г
                    и 2002 г)
                    Победитель международного коммерческого турнира "Нижегородски
                    й Дракон" 2011г
                    
                    10-ти кратный чемпион России Победитель многочисленных всероссийских и междун
                    ародных соревнованийЧерный пояс 2 дан
                  
                  `,
    description: "Специализируется на подготовке спортсменов..."
  },
  {
    ...
    achievements: `Мастер спорта международного класса
                  ...
                  Победитель и призер различных международных и всероссийских соревнований. Черный пояс, 3 дан
          ...
          >
            ...
            <div className="coach-modal-info">
              ...
              {selectedCoach.achievements && (
                <>
                  <h4>Достижения</h4>
                  <p className="coach-achievements">
                    {selectedCoach.achievements}
                  </p>
                </>
              )}
